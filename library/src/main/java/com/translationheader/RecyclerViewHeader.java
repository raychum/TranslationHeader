...
public class RecyclerViewHeader extends RelativeLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (mRecyclerWantsTouchEvent) {
            int scrollDiff = currentScroll - mDownScroll;
    ...
    public void translateHeader(float y, long duration) {
        currentScroll = (int) y;
        animate().cancel();
        animate().setDuration(duration).translationY(-y);
        Log.d(TAG, "translateHeader" + getTag() + " translationY=" + -y);
    }
